    ...
    if($flag==1){
        try {
            ...
            $db->beginTransaction();
                ...
                $disponibilidade=['disponibilidade'];
                $disponibilidade=json_encode($disponibilidade);
                $resultado=$db->query("INSERT INTO Terapeutas (cpf, disponibilidade, crp, registroMatricula, situacao) VALUES ('345','$disponibilidade', NULL, '345345', 'aprovado')");
                ...
                $disponibilidade=['disponibilidade'];
                $disponibilidade=json_encode($disponibilidade);
                $resultado=$db->query("INSERT INTO Terapeutas (cpf, disponibilidade, crp, registroMatricula, situacao) VALUES ('456','$disponibilidade','456456', NULL, 'naoAprovado')");
